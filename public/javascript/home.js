...
const quotesDsplay = document.querySelector("#quotes-h1");
...
const quoteapi = () => {
    ...
    quotesDsplay.innerHTML = quotes[currentQuoteIndex].text;
    authorquotes.innerHTML = quotes[currentQuoteIndex].from;
}

timer = setInterval(quoteapi, 10000)
